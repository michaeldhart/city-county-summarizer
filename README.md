...
- **`reports/YYYY-MM.md`** — a monthly recap of meetings that happened plus
...
the manifest, and writes `reports/YYYY-MM.md` covering:
...
reports/YYYY-MM.md              # tracked in git; one per monthly run
