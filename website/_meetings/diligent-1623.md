...
- **Salt costs spiked 30%+** for Highway Department due to reduced vendors and fuel costs
- **Claims totaling $3,378,081.35 approved**

## Attendance & housekeeping
- Roll call showed quorum present; Carl Johnson absent
- Matt Reggano participated remotely (motion approved)
- July 2, 2026 minutes approved
- Agenda approved
- No public comment

## Decisions & votes

**Claims approval ($3,378,081.35)** — **Approved** (roll call)
- Standard abstentions for Carl Johnson noted
- No discussion

**Ordinance 26-33 (speed limit reductions on Rockton, McCurry, Grade School roads)** — **FAILED** (3 yes, 7 no)
- Yes: Schneider, Wilty, Logston
- No: Schumacher, Curry, Riley, Wahberg, Patterson, Reggano, Thornberry
- Substantial discussion: no speed study conducted; concerns about reducing unmarked 55 mph to 35 mph; Highway Dept. unable to provide data as R1 speed data unavailable outside MPA area. Riley requested more information and input from Manchester Township supervisor before deciding. Logston noted traveling these roads personally and felt 35 mph "ridiculous," 45 mph "reasonable" for open, rural character.

**Ordinance 26-31 (moving Regional Planning Commission to Chapter 2: Article 7)** — **Approved** (voice vote)
- Language unchanged, just reorganization; section numbering to be corrected before final County Board vote

**Ordinance 26-32 (moving Zoning Board of Appeals to Chapter 2: Article 8)** — **Approved** (voice vote)
- Language unchanged, administrative move

**Ordinance 26-29 (Stormwater Protection/NPDES appendix)** — **Approved** (voice vote)
- Moved from subdivision ordinance to Appendix C; no language changes

**Ordinance 26-30 (Floodplain ordinance appendix)** — **Approved** (voice vote)
- Updated language from IDNR recommendations, pre-approved by IDNR
- Riley commended Jesse on work updating ordinances

## Discussion items (no vote)

**License Plate Reader (LPR) system presentation (Detective Shoots):**
- 6 permanent cameras at Janeau, Logan Ave, Orthan Blvd, Newburg, Epson, Woodstock roads
- Cameras capture license plates only, not faces or personal identifying information
- Images stored 30 days then automatically deleted
- Requires case number to search; department policy prevents random searches
- Past 30 days: detected 3,590 suspended registrations, 199 stolen plates, 13 revoked licenses, 11 stolen vehicles, 5 wanted persons
- Share data with in-state and out-of-state agencies (not federal); pre-approved sharing agreements speed investigations
- Flock system chosen for largest network and audit capabilities
- Used in multiple major cases including triple homicide, aggravated kidnapping, storage unit burglaries, dog abandonment (50 dogs), retail thefts
- Addresses social media concerns about "Big Brother"; emphasized no facial recognition, limited access, audit trails catch abuse
- Patterson noted private sector use; discussion of Flock auditing to catch officer misuse

**Sheriff's report:**
- Two serious accidents: 16-year-old at Hunter/Burr Oak (just released from hospital), fatality on Route 173
- Preparing for Boone County Fair security (unable to attend Monday finance meeting)
- Appreciation for fairgrounds facility improvements

**Highway Department (Justin):**
- Completed July road resurfacing; city starts this week (2-week project)
- **Salt prices up 30%+** from last year; now more expensive per unit than asphalt
- Causes: vendor left market (down from 3 to 2), southern states consumed reserves in unusual winter weather, diesel fuel costs
- Rockford (14,000 tons) and other counties received no salt bids; Boone County secured vendor
- Shadic Road bridge reconstruction starts Monday; closed between I-90 and US-20 for ~2.5 months

**State's Attorney (Trisha):**
- Two recent jury trial convictions: aggravated sex abuse, aggravated domestic battery (former Elgin officer, 7-year max sentence)
- Office move complete: 37 filing cabinets relocated; working in shared rooms temporarily; less accessible but managing
- LPR cameras instrumental in triple homicide case

**Public Defender (Kate):**
- Fully staffed: 5 attorneys, 2 full-time admin, 1 part-time
- Attorney Pogle joined from Winnebago County (NIU 2025 grad), handling traffic/misdemeanors
- Office renovations starting; 3-month timeline; will **zero out rent/utilities in 2027 budget**
- Attended National Specialty Courts Conference in Nashville with probation staff

**Probation:**
- Office of Statewide Pretrial announced reimbursements for counties maintaining pretrial departments
- **$1,800 reimbursement confirmed** (July-April); additional $500 pending (May-June)

**Circuit Court (Pamler):**
- Moved to basement in April, back to office July 3rd (without workstations initially)
- Used borrowed banquet tables until new workstations installed July 21st
- Lobby closed; serving public through converted "Dutch door" in back hallway (4 stations down to 1)
- Four service anniversaries: Jen Mutree (4 yrs), David Van (8 yrs), Becky Slack (11 yrs), Alice White (19 yrs)
- Hiring 1 full-time and 1 part-time clerk now that office set up

**Landfill:**
- Rejected all groundwater monitoring bids (too high)
- PACE agreed to contract extension; bringing to County Board

**UCCI trip:**
- Aug 15 deadline to register for DC trip (Aug 14-17)
- County reimbursement increased from $3,000 to $5,000
...
- **Humorous exchange** when Matt Reggano accidentally muted himself: "For the record, I didn't fall asleep. I just hit the wrong button."

- **Receptacle number three:** Circuit Clerk explained furniture delay was due to "receptacle number three" being on back order. When asked what that was, she had to inquire herself—turned out to be an electrical outlet. Wahberg quipped: "Story as old as time. Receptacle number three issues."

- **Two women and a truck:** Pamler thanked Gallino family for loaning banquet tables and joked about loading/unloading them with another woman. Board offered to help next time; response: "Don't quit your day job."

- **Tracking Justin:** When Highway Director stepped away during speed limit discussion, board joked about using LPR cameras and "pulling the data" to find him.

- **Passionate defense of rural roads:** Logston gave detailed firsthand account of traveling Manchester Township roads "on my numerous trips to Wisconsin looking for different routes" and firmly stated 35 mph is "ridiculous" for open areas with no hidden driveways.

- **Social media hot topic:** Sheriff and Detective Shoots repeatedly referenced LPR cameras as "very hot topic right now on social media" with discussion of vandalism/cameras being taken down. Detective noted monitoring social media for threats to county cameras.

- **Brain fog moment:** Chair apologized for forgetting to call vote: "I'm very brain [tired]."
