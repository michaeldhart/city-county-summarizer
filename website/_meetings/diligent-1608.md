---
title: Regional Planning Commission
body_id: planning
date: '2026-05-19'
...
_No specific attendance information available from agenda._ The meeting included roll call and approval of the agenda as standard housekeeping items. Minutes from the March 24, 2026 meeting were presented for approval.

## Decisions & votes (each with vote count and notable discussion or dissent)
_Vote counts and discussion details not available from agenda._

The following items were on the agenda for decision:
- **Motion to Approve March 24, 2026 Minutes** (Item 4.01)
- **Concept Plan PUD SUP-07-2026 at 3100 US Route 20** (Item 7.01) - Planned Unit Development for Special Use for self-service storage and outdoor storage
- **2026 Zoning Map Update** (Item 7.02) - Draft zoning map update for the county

## Discussion items (no vote)
The agenda included a general Discussion section (Item 8), but no specific topics were listed.

## Public comment
The agenda included a Public Comment period (Item 5), but no details about participants or comments were available.
